...
var InvoiceService = /** @class */ (function () {
    ...
    InvoiceService.prototype.storeInvoicedb = function (file, userId) {
        return __awaiter(this, void 0, Promise, function () {
            var newInovice, storeNewInvoice;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        newInovice = this.inoviceService.create({
                            img: file,
                            status: false,
                            amount: 0,
                            user_id: userId
                        });
                        return [4 /*yield*/, this.inoviceService.save(newInovice)];
                    case 1:
                        storeNewInvoice = _a.sent();
                        return [2 /*return*/, !!storeNewInvoice];
                }
            });
        });
    };
    InvoiceService.prototype.allTransactions = function (query, user) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.paginationService.paginate(this.inoviceService, query, conditions, ['id', 'amount', 'status', 'created_at'])];
                    case 1:
