...
var DepositeController = /** @class */ (function () {
    function DepositeController(depositeService) {
        this.depositeService = depositeService;
    }
    DepositeController.prototype.getDate = function () {
        return this.depositeService.checkInBinance();
    };
    DepositeController.prototype.allTransaction = function (query, user) {
    ...
    __decorate([
        common_1.Post()
    ], DepositeController.prototype, "getDate");
    __decorate([
        common_1.Get('get-transactions'),
        __param(0, common_1.Query()), __param(1, get_current_user_1.GetCurrentUser())
    ], DepositeController.prototype, "allTransaction");
    DepositeController = __decorate([
        common_1.Controller('deposite')
    ], DepositeController);
