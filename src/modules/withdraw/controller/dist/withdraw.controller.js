...
var WithDrawController = /** @class */ (function () {
    function WithDrawController(withdrawService) {
        this.withdrawService = withdrawService;
    }
    WithDrawController.prototype.allTransaction = function (query, user) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.withdrawService.allTransactions(query, user)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    WithDrawController.prototype.orderWithdraw = function (data, user) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ], WithDrawController.prototype, "allTransaction");
    __decorate([
        common_1.Post('order'),
